...
def home():
    ...
    # Unpacking sorted data into variables
    ...
    # Creating a formatted string to display the sorted data
...
def queens():
    ...
    x_offset = 100
    x_scale = 800 / (2020 - 2003)  # Width divided by number of intervals (2020-2003)
    y_offset = 450
    y_scale = 400 / 40  # Height divided by percentage range (0% to 40%)

    # Coordinate calculations for each borough
    boroughs = {
        "Manhattan": [],
        "Bronx": [],
        "Queens": [],
...
#micro summary
    ...
    # Calculating statistics for the obesity rate in each borough and formatting text
    borough_stats = {}
    for borough, points_list in boroughs.items():
    ...
    # Prepare formatted text for each borough
    formatted_texts = {}
    ...
    # Here you can pass 'formatted_texts' to your template
